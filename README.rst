...
, with early contributions from `Polar Gliders <https://sebswart.com/>`_ at the University of Gothenburg. We aim to implement Best Practices developed by `OceanGliders <https://www.oceangliders.org/>`_ in the ongoing discussions `here <https://github.com/OceanGlidersCommunity>`_.
